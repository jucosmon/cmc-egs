                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-for="dept in departments.data" :key="dept.id">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">{{ dept.code }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">{{ dept.name }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        {{ dept.dean ? dept.dean.first_name + ' ' + dept.dean.last_name : 'N/A' }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">{{ dept.programs_count }}</td>
