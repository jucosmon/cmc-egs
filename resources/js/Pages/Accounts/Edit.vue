...
const form = useForm({
    ...
    block_id:
        props.account.student && props.account.student.block_id
            ...
            : "",
    birth_place:
        props.account.student && props.account.student.birth_place
            ? props.account.student.birth_place
            : "",
    religion:
        props.account.student && props.account.student.religion
            ? props.account.student.religion
            : "",
    citizenship:
        props.account.student && props.account.student.citizenship
            ? props.account.student.citizenship
            : "Filipino",
    father_name:
        props.account.student && props.account.student.father_name
            ? props.account.student.father_name
            : "",
    mother_name:
        props.account.student && props.account.student.mother_name
            ? props.account.student.mother_name
            : "",
    elementary_school:
        props.account.student && props.account.student.elementary_school
            ? props.account.student.elementary_school
            : "",
    elementary_year:
        props.account.student && props.account.student.elementary_year
            ? props.account.student.elementary_year
            : "",
    secondary_school:
        props.account.student && props.account.student.secondary_school
            ? props.account.student.secondary_school
            : "",
    secondary_year:
        props.account.student && props.account.student.secondary_year
            ? props.account.student.secondary_year
            : "",
    avatar: null,
    type: props.userType,
});
